...
const Home: React.FC = () => {
  ...
  return (
    <div style={containerStyle}>
      <div style={{ flex: '1', display: 'flex', justifyContent: 'center', alignItems: 'flex-end', paddingBottom: '1%', paddingLeft: '5%' }}>
        <img src="/RouteF4.png" alt="Route F4" style={imageStyle} />
      </div>
      <div style={{ flex: '1', display: 'flex', justifyContent: 'center', alignItems: 'flex-start', paddingBottom: '10%', paddingRight: '35%' }}>
        <img src="/RouteF3.png" alt="Route F3" style={imageStyle} />
      </div>

      {/* QRコードとTOPボタン */}
      <div style={{ position: 'absolute', right: '38%', top: '55%', transform: 'translateY(-50%)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
        <span style={{ fontSize: '62px', fontWeight: 'bold', color: 'black', marginBottom: '60px' }}>QRコード</span>
        <button onClick={() => navigate('/')} style={buttonStyle}>TOP</button>
      </div>

      {/* 4↑3 */}
      <div style={{ position: 'absolute', right: '20%', top: '45%', transform: 'translateY(-50%)', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
